...
export default function RebuildPage() {
  return (
    <div className="rebuild-page relative min-h-dvh w-full overflow-x-hidden bg-white">
      ...
      <div className="relative z-[1] mx-auto flex max-w-[1600px] flex-col gap-10 px-4 py-8 sm:px-6 sm:py-12 lg:flex-row lg:items-start lg:justify-between lg:gap-6 lg:pl-16 lg:pr-6 lg:pt-12 lg:pb-12">
        <aside className="rebuild-page__aside flex w-full shrink-0 flex-col gap-10 lg:sticky lg:top-0 lg:min-h-[min(100dvh,820px)] lg:w-[419px] lg:justify-between lg:pr-6">
          <Navbar />
          <Hero />
        </aside>

        <div className="rebuild-page__main flex w-full min-w-0 flex-1 flex-col gap-10 rounded-b-3xl bg-white sm:gap-12 lg:px-12">
          <WorkSection />
          <StudioSection />
