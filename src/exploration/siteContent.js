...
export const SITE_WORK = [
  ...
  },
  {
    ...
    workCardFooterRotatingLines: [
      "From ATL311 friction to finished reports.",
      "Map, status, updates—in one flow.",
      "Fewer steps. Clearer feedback.",
      "Built for phones first.",
    ],
    workCardNuggetsMonochrome: true,
    workCardNuggetsAriaLabel: "Ways of working",
    nuggets: [
      { label: "Wireframing", color: "#ffffff", icon: "Layout01Icon" },
      { label: "Prototyping", color: "#e5e5e5", icon: "Layers01Icon" },
      { label: "Research synthesis", color: "#e5e5e5", icon: "BookUserIcon" },
      { label: "Competitive audit", color: "#404040", icon: "GridViewIcon" },
      { label: "Motion", color: "#404040", icon: "MagicWand01Icon" },
    ],
    workCardTeaserLead:
      "ATL311 left too many civic reports unfinished. InCity tightens reporting, maps, and case status for Atlanta residents.",
    workCardStutters: [],
    workCardFinale: "Measured lifts in completion—and zero abandoned submissions.",
    summary:
      "Rework of non-emergency civic reporting: fewer buried steps, live case status, map-based context, and outcomes that dramatically cut errors and drop-off.",
    alt: "InCity — civic mobile concept",
    featured: true,
    overlayTitle: "InCity",
    overlaySubtitle: "ATL311 · civic reporting",
